...
//go:generate minimock -i backend-bootcamp-assignment-2024/internal/services/renting/usecases/createflat.TxManager -o tx_manager_mock_test.go -n TxManagerMock -p createflat
...
type TxManagerMock struct {
	...
	funcWithinTransaction          func(ctx context.Context, f func(context.Context) bool) (err error)
	inspectFuncWithinTransaction   func(ctx context.Context, f func(context.Context) bool)
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Expect(ctx context.Context, f func(context.Context) bool) *mTxManagerMockWithinTransaction {
	...
	mmWithinTransaction.defaultExpectation.params = &TxManagerMockWithinTransactionParams{ctx, f}
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Inspect(f func(ctx context.Context, f func(context.Context) bool)) *mTxManagerMockWithinTransaction {
...
func (mmWithinTransaction *mTxManagerMockWithinTransaction) Set(f func(ctx context.Context, f func(context.Context) bool) (err error)) *TxManagerMock {
	if mmWithinTransaction.defaultExpectation != nil {
...
// Then helper
func (mmWithinTransaction *mTxManagerMockWithinTransaction) When(ctx context.Context, f func(context.Context) bool) *TxManagerMockWithinTransactionExpectation {
	if mmWithinTransaction.mock.funcWithinTransaction != nil {
		mmWithinTransaction.mock.t.Fatalf("TxManagerMock.WithinTransaction mock is already set by Set")
	}
	...
	expectation := &TxManagerMockWithinTransactionExpectation{
		...
		params: &TxManagerMockWithinTransactionParams{ctx, f},
	}
...
func (mmWithinTransaction *TxManagerMock) WithinTransaction(ctx context.Context, f func(context.Context) bool) (err error) {
	...
	if mmWithinTransaction.inspectFuncWithinTransaction != nil {
		mmWithinTransaction.inspectFuncWithinTransaction(ctx, f)
	}

	mm_params := TxManagerMockWithinTransactionParams{ctx, f}
	...
	if mmWithinTransaction.WithinTransactionMock.defaultExpectation != nil {
		...
		mm_got := TxManagerMockWithinTransactionParams{ctx, f}
	...
	if mmWithinTransaction.funcWithinTransaction != nil {
		return mmWithinTransaction.funcWithinTransaction(ctx, f)
	}
	mmWithinTransaction.t.Fatalf("Unexpected call to TxManagerMock.WithinTransaction. %v %v", ctx, f)
	return
}
